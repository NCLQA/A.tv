...
45403 채널 정보 확인
    ...
    미디어 메뉴 진입
    Sleep    8
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/player_view
    Sleep    1
...
45409 다운로드 관리 버튼 선택
    ...
    미디어 메뉴 진입
    Sleep    8
    Wait Until Element Is Visible    com.skt.nugu.apollo:id/iv_right_btn
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/iv_right_btn
    Wait Until Element Is Visible    Xpath=//android.widget.TextView[@resource-id="com.skt.nugu.apollo:id/tv_title" and @text="다운로드 관리"]    #다운로드 관리 타이틀 노출 확인
...
45411 추천 정보 노출 상태에서 상세정보 보기 진입
    ...
    END
    Sleep    1
    Wait Until Element Is Visible    com.skt.nugu.apollo:id/player_view    #상세정보 타이틀 노출 확인
...
45412 플레이어 컴포넌트 노출 상태에서 상세정보 보기 진입
    ...
    미디어 메뉴 진입
    full 화면 진입
    FOR  ${i}  IN RANGE    0    10    #상세정보 버튼 인식 시점까지 컴포넌트 호출 반복
    ...
    END
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/player_view    #상세정보 타이틀 노출 확인
...
45413 상세정보 > 닫기 버튼 선택
    ...
    FOR  ${i}  IN RANGE    0    10    #상세정보 버튼 인식 시점까지 컴포넌트 호출 반복
        ...
        Sleep    5
    END
    Wait Until Element Is Visible    com.skt.nugu.apollo:id/player_view
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/iv_close    #닫기 버튼 선택
    Sleep    1
    Page Should Not Contain Element    com.skt.nugu.apollo:id/tv_synopsis    #상세정보 닫힘 여부 확인
...
45418 미디어 종료
    ...
    미디어 메뉴 진입
    Sleep    5
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/iv_left_btn
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/iv_left_btn
    Sleep    2
...
45421 편성표 > 닫기 버튼 선택
    ...
    FOR  ${i}  IN RANGE    0    5    #편성표 버튼 인식 시점까지 컴포넌트 호출 반복
        Wait Until Keyword Succeeds    1 min    3 sec    Click Element    class=android.view.View
        ${pass}=    Run Keyword And Return Status    Click Element    com.skt.nugu.apollo:id/iv_schedule
        Exit For Loop If    ${pass}
        Sleep    1
    END
    Sleep    1
...
45428 일반 채널 (Seeking 가능) > 채널, 콘텐츠 정보
    ...
    Sleep    1
    Wait Until Element Is Visible    com.skt.nugu.apollo:id/player_view    #상세 정보 노출 확인  
...
45470 플레이어 > PIP 재생 중 Full player 전환
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    class=android.view.View
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/iv_play_pause
    Sleep    1
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/tabBorder
    Sleep    1
    ${current_runtime}=    Get Text    com.skt.nugu.apollo:id/tv_runtime
...
45483 플레이어 > 컴포넌트 미노출 상태
    ...
    FOR  ${i}  IN RANGE    0    5    #컴포넌트 정상 노출될때까지 화면 탭 반복
        Wait Until Keyword Succeeds    1 min    3 sec    Click Element    class=android.view.View
        ${pass}=    Run Keyword And Return Status    Wait Until Page Contains Element    com.skt.nugu.apollo:id/iv_play_pause
        Exit For Loop If    ${pass}
        Sleep    1
    END  
    Sleep    5
    Page Should Not Contain Element    com.skt.nugu.apollo:id/iv_play_pause
    ...
    FOR  ${i}  IN RANGE    0    5    #컴포넌트 정상 노출될때까지 화면 탭 반복
        ...
        Sleep    1
    END
    Click Element    com.skt.nugu.apollo:id/tabBorder    #화면 탭
    Sleep    2
    Page Should Not Contain Element    com.skt.nugu.apollo:id/iv_play_pause
...
45488 다운로드 관리
    ...
    미디어 메뉴 진입
    Sleep    8
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/iv_right_btn
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/iv_right_btn    #다운로드 관리 진입 
    Sleep    1
...
45527 다운로드 닫기 버튼
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/iv_right_btn    #닫기 버튼 선택
    Sleep    1
...
59214 다운로드 관리 화면 구성 및 제공 문구 개선
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/cl_download_on_layout    #<다운로드 공간 설정> 영역
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/downloadUseContainer    #<자동 다운로드 사용> 영역
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/cl_bottom_area    #<다운로드 콘텐츠> 영역

    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/autoDownloadGuide    #자동 다운로드 안내 버튼 선택
...
81857 다운로드 관리 - 다운로드 콘텐츠
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/cl_bottom_area    #<다운로드 콘텐츠> 영역
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Element Text Should Be    com.skt.nugu.apollo:id/tv_guide    다운로드한 콘텐츠가 없어요.
    Sleep    1

    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/tv_delete_all    #전체삭제 버튼
...
81856 다운로드 관리 - 영역 순서
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/iv_right_btn    #다운로드 관리 진입
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Element Should Be Visible    Xpath=//android.view.ViewGroup[@resource-id="com.skt.nugu.apollo:id/cl_download_on_layout" and @index="0"]    #다운로드 공간 설정 영역
    Wait Until Keyword Succeeds    1 min    3 sec    Element Should Be Visible    Xpath=//android.view.ViewGroup[@resource-id="com.skt.nugu.apollo:id/downloadUseContainer" and @index="1"]    #자동 다운로드 사용 영역
    Wait Until Keyword Succeeds    1 min    3 sec    Element Should Be Visible    Xpath=//android.view.ViewGroup[@resource-id="com.skt.nugu.apollo:id/cl_bottom_area" and @index="4"]    #다운로드 콘텐츠 영역

*81860 프로농구 홈 - 응원팀 미설정
    #1. 에이닷 실행 > "앱" > "프로농구" 선택
    #2. 응원팀 영역 노출 확인
    ...
    프로농구 메뉴 진입
    Sleep    8
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/cl_my_team_empty_area
    Sleep    1

*81863 프로농구 홈 - 응원팀 설정 팝업
    #0. 응원팀 미설정 상태
    #1. 에이닷 실행 > "앱" > "프로농구" 선택
    ...
    프로농구 메뉴 진입
    Sleep    8
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/textView6
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.TextView[@resource-id="com.skt.nugu.apollo:id/tv_team_name" and @text="대구 한국가스공사"]
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/tv_ok
    Sleep    1
    Page Should Not Contain Element    Xpath=//android.view.ViewGroup[@resource-id="com.skt.nugu.apollo:id/cl_root"]
...
*81861 프로농구 홈 - 응원팀 정보
    ...
    프로농구 메뉴 진입
    Sleep    8
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/iv_my_team_logo
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Element Should Be Visible    com.skt.nugu.apollo:id/tv_title
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/buttonExit
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/cl_change_my_team
    Sleep    1
...
*81865 프로농구 홈 - 응원팀 변경
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/cl_change_my_team
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.TextView[@resource-id="com.skt.nugu.apollo:id/tv_team_name" and @text="서울 SK"]
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/tv_ok
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/cl_change_my_team
...
*84027 프로농구 홈 리그정보카드 타이틀 확인
    #1. 에이닷 실행 > "앱" > "프로농구" 선택
    #2. 프로농구 홈 > 리그 정보 영역 타이틀명 확인    /    2. "23-24 리그 정보" 노출 시 pass

    [Tags]    Player
    프로농구 메뉴 진입
    Sleep    8
    Wait Until Keyword Succeeds    1 min    3 sec    Element Should Be Visible    Xpath=//android.widget.TextView[@text="23-24 리그 정보"]

*84028 프로농구 홈 리그정보카드 캘린더 확인
    #1. 에이닷 실행 > "앱" > "프로농구" 선택
    #2. 프로농구 홈 > 리그 정보 영역 > 캘린더 선택
    #3. 캘린더 이전(<) 버튼 미 노출 시점까지 클릭    /    3. 이전연도(2023) 노출 시 pass 

    [Tags]    Player
    프로농구 메뉴 진입
    Sleep    8
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/pickDate
    Sleep    1

    FOR  ${i}  IN RANGE    0    12    #이전버튼(<) 미 노출 시점까지 클릭
        #Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.ImageButton[@content-desc="Previous Month"]
        #${pass}    Run Keyword And Return Status    Page Should Not Contain Element    Xpath=//android.widget.ImageButton[@content-desc="Previous Month"]
        #Exit For Loop If    ${pass}
    END
    Sleep    1
    Wait Until Element Is Visible    xpath=//*[contains(@content-desc, '2023')]    #"2023" 포함된 엘리먼트 존재 확인
...
*84026 통합검색 Shorts 검색 후 영상 재생 확인
    ...
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//androidx.compose.ui.platform.ComposeView[@resource-id="com.skt.nugu.apollo:id/main_compose_view"]/android.view.View/android.view.View/android.view.View/android.view.View/androidx.compose.ui.viewinterop.ViewFactoryHolder/android.widget.FrameLayout/android.widget.FrameLayout/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View[2]/android.widget.Button[2]    #text 입력 후 이동 버튼
    Sleep    2
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    Xpath=//android.widget.TextView[@text="동영상"]
    Sleep    1
    Run Process    adb logcat -c    shell=True
    Run Keyword And Ignore Error    Remove File    D://RFA/log.txt

    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=(//android.widget.FrameLayout[@resource-id="com.skt.nugu.apollo:id/fullscreen_nav_host_fragment_container"])[2]/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[1]/android.widget.Button    #숏츠 첫번째 영상 선택
    Sleep    5
...
*59088 선호도 선택 완료
    ...
    FOR  ${i}  IN RANGE    0    5    #좋아요 버튼 선택 시점까지 컴포넌트 호출 반복
        Wait Until Keyword Succeeds    1 min    3 sec    Click Element    class=android.view.View
        ${info_contain}=    Run Keyword And Return Status    Click Element    com.skt.nugu.apollo:id/cl_like
        Exit For Loop If    ${info_contain}
        Sleep    1
    END
    Sleep    2
    ...
    FOR  ${i}  IN RANGE    0    5    #싫어요 버튼 선택 시점까지 컴포넌트 호출 반복
        Wait Until Keyword Succeeds    1 min    3 sec    Click Element    class=android.view.View
        ${info_contain}=    Run Keyword And Return Status    Click Element    com.skt.nugu.apollo:id/cl_disLike
        Exit For Loop If    ${info_contain}
        Sleep    1
    END
    Sleep    2
