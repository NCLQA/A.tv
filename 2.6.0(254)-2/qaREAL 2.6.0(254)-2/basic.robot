...
45484 플레이어 > 컴포넌트 미노출 상태에서 채널 전환
    #1. 에이닷 실행 > "앱" > "TV" 선택 > 최상단 영상 진입
    #2. 화면 탭 > full player 진입
...
45485 플레이어 > 컴포넌트 미노출 상태에서 콘텐츠 전환
    #1. 에이닷 실행 > "앱" > "TV" 선택 > 최상단 영상 진입
    #2. 화면 탭 > full player 진입
...
59232 편성표 - 도움말
    ...
    Click Element    com.skt.nugu.apollo:id/iv_schedule
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/labelScheduleInfo    #편성표 진입 확인
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Element Text Should Be    com.skt.nugu.apollo:id/title    채널 안내    
    Wait Until Keyword Succeeds    1 min    3 sec    Element Text Should Be    com.skt.nugu.apollo:id/subTitle    A.tv는 VOD를 특정 테마로 묶어 채널을 편성해요.\n플래그가 있는 채널은 조금 다른 기준으로 제공되는\n채널이에요.
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/confirmButton    #확인 버튼 선택
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/refreshButton    #새로고침 버튼
    Page Should Not Contain Element    com.skt.nugu.apollo:id/title
