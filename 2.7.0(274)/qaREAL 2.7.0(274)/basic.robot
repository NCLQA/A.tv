...
81857 다운로드 관리 - 다운로드 콘텐츠
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/cl_bottom_area    #<다운로드 콘텐츠> 영역
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Element Text Should Be    com.skt.nugu.apollo:id/tv_blank_noti    다운로드한 콘텐츠가 없어요.
    Sleep    1
...
84026 통합검색 Shorts 검색 후 영상 재생 확인
    ...
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Input Text    Xpath=//android.widget.EditText    프로야구 숏츠 보여줘
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.FrameLayout[3]/android.widget.FrameLayout/android.view.ViewGroup/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View/android.view.View/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View[2]/android.widget.Button[2]    #text 입력 후 이동 버튼
    Sleep    2
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    Xpath=//android.widget.TextView[@text="A.tv 프로야구 Shorts"]
    Sleep    1
