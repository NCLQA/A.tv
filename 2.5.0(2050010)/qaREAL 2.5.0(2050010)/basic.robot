...
다운로드 관리 화면 구성 및 제공 문구 개선
    #1. 에이닷 실행 > "메뉴" > "TV" 선택 > 최상단 영상 진입
    #2. 화면 탭 > full player 진입
    #3. 컴포넌트 호출하여 다운로드 관리 진입    /    3. 자동 다운로드 사용, 다운로드 공간 설정, 다운로드 콘텐츠 영역 구분 확인
    #4. 자동 다운로드 안내 버튼 선택 및 5초 대기    /    4. 토스트 팝업 안내 문구 일치 확인 및 5초 경과 시 토스트 팝업 노출 종료 확인
    #5. 자동 다운로드 안내 버튼 재선택 > 팝업 바깥영역 탭    /     5. 토스트 팝업 노출 종료 확인 시 pass
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/textView24    #자동 다운로드 사용
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/textView28    #다운로드 공간 설정
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/textView47    #다운로드 콘텐츠

    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/autoDownloadGuide    #자동 다운로드 안내 버튼 선택
    Wait Until Keyword Succeeds    1 min    3 sec    Element Text Should Be    Xpath=//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.FrameLayout[3]/android.widget.FrameLayout/android.view.ViewGroup/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View/android.view.View/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup[2]/android.view.ViewGroup/android.widget.LinearLayout/android.widget.LinearLayout/androidx.appcompat.widget.LinearLayoutCompat/android.widget.TextView    기기를 충전 중이며 A.(에이닷) 앱의 배터리 사용량 설정이\n‘제한 없음'으로 되어 있는 경우, 추천 콘텐츠가 자동 다운로드돼요.
    Sleep    5
    Page Should Not Contain Element    Xpath=//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.FrameLayout[3]/android.widget.FrameLayout/android.view.ViewGroup/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View/android.view.View/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup[2]/android.view.ViewGroup/android.widget.LinearLayout/android.widget.LinearLayout/androidx.appcompat.widget.LinearLayoutCompat/android.widget.TextView

    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/autoDownloadGuide    #자동 다운로드 안내 버튼 선택
    Swipe By Percent    50    50    50    50    #팝업 바깥영역 탭
    Page Should Not Contain Element    Xpath=//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.FrameLayout[3]/android.widget.FrameLayout/android.view.ViewGroup/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View/android.view.View/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup[2]/android.view.ViewGroup/android.widget.LinearLayout/android.widget.LinearLayout/androidx.appcompat.widget.LinearLayoutCompat/android.widget.TextView
...
편성표 - 도움말
    ...
    Page Should Contain Element    Xpath=//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/androidx.appcompat.widget.LinearLayoutCompat/androidx.appcompat.widget.LinearLayoutCompat[2]/android.widget.ImageView    #ON AIL 플래그 노출 확인
    Page Should Contain Element    Xpath=//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/androidx.appcompat.widget.LinearLayoutCompat/androidx.appcompat.widget.LinearLayoutCompat[3]/android.widget.ImageView    #정주행 플래그 노출 확인
    Element Text Should Be    Xpath=//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/androidx.appcompat.widget.LinearLayoutCompat/androidx.appcompat.widget.LinearLayoutCompat[1]/android.widget.TextView    생방송 채널
    Element Text Should Be    Xpath=//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/androidx.appcompat.widget.LinearLayoutCompat/androidx.appcompat.widget.LinearLayoutCompat[2]/android.widget.TextView    VOD 스트리밍 채널
    Element Text Should Be    Xpath=//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/androidx.appcompat.widget.LinearLayoutCompat/androidx.appcompat.widget.LinearLayoutCompat[3]/android.widget.TextView    하나의 시리즈로 만들어진 채널
    Element Text Should Be    Xpath=//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/androidx.appcompat.widget.LinearLayoutCompat/android.widget.TextView[3]    *LIVE와 ON AIR 채널은 재생 속도 변경, 건너뛰기 등의\n기능을 이용할 수 없어요.
    
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/confirmButton    #확인 버튼 선택
    Page Should Not Contain Element    com.skt.nugu.apollo:id/title    #채널 안내 팝업 종료 확인