...
A. tv 진입
    ...
    Sleep    5
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/home_title   
...
자동 다운로드 설정 ON / OFF
    ...
    Click Element    Xpath=//android.widget.TextView[@text="TV"]
    Sleep    8
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    com.skt.nugu.apollo:id/storageManager
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skt.nugu.apollo:id/storageManager    #다운로드 관리 진입 
    Sleep    5
...
상하좌우 스와이프
    ...
    Sleep    1
    ${right_swipe}    Get Text    Xpath=//android.widget.TextView[@resource-id="com.skt.nugu.apollo:id/tv_title"]   
    Wait Until Keyword Succeeds    1 min    3 sec    Swipe By Percent    30    50    70    50    #좌측 스와이프
    Sleep    1
    ${left_swipe}    Get Text    Xpath=//android.widget.TextView[@resource-id="com.skt.nugu.apollo:id/tv_title"]
...
다운로드 목록 UI 확인 (image / text) 
    ...
    IF    ${noti_status}
        Element Text Should Be    com.skt.nugu.apollo:id/tv_blank_noti    다운로드한 콘텐츠가 여기 표시됩니다.
    ELSE
        Wait Until Element Is Visible    com.skt.nugu.apollo:id/v_dim    #콘텐츠 이미지
        ...
        Should Not Be Empty    Get text    com.skt.nugu.apollo:id/tv_title   
