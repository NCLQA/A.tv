...
전체 채널 및 콘텐츠 재생 확인
    ...
    Click Element    Xpath=//android.widget.TextView[@text="TV"]
    Sleep    8
    Wait Until Keyword Succeeds    1 min    3 sec    Wait Until Element Is Visible    class=android.view.View 
...
탐색 동작 (FW)
    ...
    ${time_string1}    Set Variable    ${current_runtime}       
    ${current_runtime_seconds}    Convert Time    ${time_string1}    
    ${time_string2}    Set Variable    ${forward_runtime}
